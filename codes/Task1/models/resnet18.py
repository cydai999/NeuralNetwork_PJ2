...
class ResNet(nn.Module):
    def __init__(self, num_classes=10, dropout_rate=0.0):
        ...
        self.layer3 = nn.Sequential(
            ResNetBasicBlock(64, 128, [2, 1]),
            ResNetBasicBlock(128, 128, [1, 1])
        )
        self.layer4 = nn.Sequential(
            ResNetBasicBlock(128, 256, [2, 1]),
            ResNetBasicBlock(256, 256, [1, 1])
        )
        self.layer5 = nn.Sequential(
            ResNetBasicBlock(256, 512, [2, 1]),
            ResNetBasicBlock(512, 512, [1, 1])
        )
